            ...
            <div className="product-page">
                ...
                <div className="row justify-content-center text-center g-mb-20 g-mt-50">
                    <div className="col-lg-9">
                        <div className="text-uppercase  g-brd-primary g-mb-20">
                            <h2 className="h1 u-heading-v2__title g-line-height-1_3 g-font-weight-600 g-font-size-40 g-color-black -light-v2 g-mb-minus-10">How It Works</h2>
                        </div>
                ...
                <section>
                    <div className="container-fluid">
                        ...
                        <div className="row">
                            <div
                                className="col-md-6 u-bg-overlay g-flex-centered g-height-100vh--md g-min-height-300 g-bg-img-hero g-bg-black-opacity-0_7--after text-md-right g-py-40 g-pr-50--md"
                                style={{backgroundImage: 'url(/img/5e09feeac38b0.png)'}}
                                data-calc-target="#js-header">
                                <div className="w-100 u-bg-overlay__inner g-py-100">
                                    <h3 className="h4 g-font-weight-700 g-color-primary g-mb-20">Investors can</h3>

                                    <div
                                        className="g-brd-left g-brd-left-none--md g-brd-right--md g-brd-10 g-brd-primary g-color-white g-pl-30 g-pr-20 g-pl-0--lg g-mb-30">
                                        <h2 className="text-uppercase g-line-height-0_9 g-font-weight-700 g-font-size-40 g-font-size-56--md g-font-size-76--lg mb-0">Invest on<br/> farmers
                                        </h2>
                                    </div>

                                    <a className="btn btn-lg u-btn-darkgray u-btn-inset mx-2" href="#!">
                                        Read more
                                        <i className="fa fa-arrow-left g-color-primary ml-2"></i>
                                    </a>
                                </div>
                            </div>

                            <div
                                className="col-md-6 u-bg-overlay g-flex-centered g-height-100vh--md g-min-height-300 g-bg-img-hero g-bg-black-opacity-0_7--after g-py-40 g-pl-50--md"
                                style={{backgroundImage: 'url(/img/Female-Farmer-1.png)'}}
                                data-calc-target="#js-header">


                                <div className="w-100 u-bg-overlay__inner g-py-100">
                                    <h3 className="h4 g-font-weight-700 g-color-primary g-mb-20">Farmers can</h3>

                                    <div className="g-brd-left g-brd-10 g-brd-primary g-color-white g-pl-30 g-mb-30">
                                        <h2 className="text-uppercase g-line-height-0_9 g-font-weight-700 g-font-size-40 g-font-size-56--md g-font-size-76--lg mb-0">Apply for<br/> investment
                                        </h2>
                                    </div>

                                    <a className="btn btn-lg u-btn-darkgray u-btn-inset mx-2" href="#!">
                                        <i className="fa fa-arrow-right g-color-primary mr-2"></i>
                                        Read more
                                    </a>
                                </div>
                            </div>
                ...
                <section id="donators" className="g-py-100">
                    <div className="container g-max-width-780 text-center g-mb-60">
                        <div className="text-center u-heading-v8-1 g-mb-35">
                            <h2 className="h3 text-uppercase u-heading-v8__title g-font-weight-700 g-font-size-26 mb-0">Best
                                <strong className="g-bg-gray-dark-v1 g-color-primary">Investors</strong></h2>
                        </div>

                        <p className="mb-0">Integer accumsan maximus leo, et consectetur metus vestibulum in. Vestibulum
                            viverra justo odio. Donec eu nulla leo. Vivamus risus lacus</p>
                    </div>


                    <div className="container">
                        <div className="row">
                            <div className="col-6 col-sm-4 col-lg-2 g-mb-50 g-mb-0--lg">

                                <figure className="text-center">

                                    <div
                                        className="mx-auto g-width-130 g-height-130 g-brd-around g-brd-5 g-brd-white rounded-circle g-mb-15">
                                        <img className="g-width-120 g-height-120 rounded-circle" src="/img/1.jpg" alt="Image Description"/>
                                    </div>

                                    <h4 className="h6 text-uppercase g-color-black g-font-weight-700 g-mb-5">Mark
                                        Spencer</h4>
                                    <p className="text-lowercase g-font-size-12">Molestie ullamcorper</p>

                                    <div className="d-inline-block">
                                        <div
                                            className="d-flex justify-content-between w-100 g-max-width-145 g-bg-black g-color-white g-font-size-10 g-font-weight-700 text-uppercase">
                                            <span className="u-ns-bg-v7-right g-bg-black g-px-15 g-py-4">Need</span>
                                            <span
                                                className="g-bg-primary g-color-black g-font-weight-700 g-py-4 g-px-7 g-px-15--md">GHS5000</span>
                                        </div>
                                    </div>
                            ...
                            <div className="col-6 col-sm-4 col-lg-2 g-mb-50 g-mb-0--lg">
                                ...
                                <figure className="text-center">
                                    ...
                                    <div
                                        className="mx-auto g-width-130 g-height-130 g-brd-around g-brd-5 g-brd-white rounded-circle g-mb-15">
                                        <img className="g-width-120 g-height-120 rounded-circle" src="/img/4.jpg" alt="Image Description"/>
                                    </div>

                                    <h4 className="h6 text-uppercase g-color-black g-font-weight-700 g-mb-5">Abraham Nwoke</h4>
                                    <p className="text-lowercase g-font-size-12">Molestie ullamcorper</p>
                                    ...
                                    <div className="d-inline-block">
                                        <div
                                            ...
                                            <span className="u-ns-bg-v7-right g-bg-black g-px-15 g-py-4">Need</span>
                                            <span
                                                className="g-bg-primary g-color-black g-font-weight-700 g-py-4 g-px-7 g-px-15--md">GHS9000</span>
                                        </div>
                                    </div>
                            ...
                            <div className="col-6 col-sm-4 col-lg-2 g-mb-50 g-mb-0--lg">
                                ...
                                <figure className="text-center">
                                    ...
                                    <div className="mx-auto g-width-130 g-height-130 g-brd-around g-brd-5 g-brd-white rounded-circle g-mb-15">
                                        <img className="g-width-120 g-height-120 rounded-circle" src="/img/6.jpg" alt="Image Description"/>
                                    </div>
                                    ...
                                    <div className="d-inline-block">
                                        <div
                                            ...
                                            <span className="u-ns-bg-v7-right g-bg-black g-px-15 g-py-4">Need</span>
                                            <span
                                                className="g-bg-primary g-color-black g-font-weight-700 g-py-4 g-px-7 g-px-15--md">GHS7000</span>
                                        </div>
                                    </div>
                            ...
                            <div className="col-6 col-sm-4 col-lg-2 g-mb-50 g-mb-0--md">

                                <figure className="text-center">

                                    <div className="mx-auto g-width-130 g-height-130 g-brd-around g-brd-5 g-brd-white rounded-circle g-mb-15">
                                        <img className="g-width-120 g-height-120 rounded-circle" src="/img/5.jpg" alt="Image Description"/>
                                    </div>
                                    ...
                                    <div className="d-inline-block">
                                        <div
                                            ...
                                            <span className="u-ns-bg-v7-right g-bg-black g-px-15 g-py-4">Need</span>
                                            <span
                                                className="g-bg-primary g-color-black g-font-weight-700 g-py-4 g-px-7 g-px-15--md">GHS8000</span>
                                        </div>
                                    </div>
                                ...
                                <figure className="text-center">
                                    ...
                                    <div className="d-inline-block">
                                        <div
                                            ...
                                            <span className="u-ns-bg-v7-right g-bg-black g-px-15 g-py-4">Need</span>
                                            <span
                                                className="g-bg-primary g-color-black g-font-weight-700 g-py-4 g-px-7 g-px-15--md">GHS2000</span>
                                        </div>
                                    </div>
                            ...
                            <div className="col-6 col-sm-4 col-lg-2">
                                ...
                                <figure className="text-center">
                                    ...
                                    <div className="mx-auto g-width-130 g-height-130 g-brd-around g-brd-5 g-brd-white rounded-circle g-mb-15">
                                        <img className="g-width-120 g-height-120 rounded-circle" src="/img/user.png" alt="Image Description"/>
                                    </div>


                                    <h4 className="text-uppercase g-font-weight-700 h6 g-color-gray-dark-v1 g-mb-10">You
                                        can be here</h4>
                                    <a href="#!"
                                       className="btn btn-block u-btn-primary text-uppercase g-font-weight-700 g-font-size-11 g-color-gray-dark-v1 g-brd-none rounded-0 g-py-10 g-py-10--md g-px-5">
                                        Became an investor</a>
                                </figure>
                            </div>
                        </div>
                    </div>
