        ...
        <LandingPageLayout>
            <div className="product-page">
                        ...
                        <div className="row">
                            <div className="col-md-6 g-pl-100--lg">
                                <div className="text-uppercase u-heading-v6-2 g-mb-15 g-ml-minus-55 g-ml-minus-90--md">
                                    ...
                                    <h2 className="u-heading-v6__title g-font-weight-700 g-font-size-26 g-brd-primary mb-0">FBO MONITORING</h2>
                                </div>
                ...
                <section className=" auto-init height-is-based-on-content use-loading auth-page" data-options="{direction: 'reverse', settings_mode_oneelement_max_offset: '150'}">
                   ...
                   <div className="container">
                       <div className="text-center u-heading-v2-2--bottom g-brd-primary g-mb-50 g-pos-rel">
                           <h2 className="text-uppercase g-line-height-1_1 g-font-weight-700 g-font-size-26 g-mb-15">Individual Farmer</h2>
                           ...
                           <div className="row">
                               <div className="col-lg-4 g-mb-30">
                                   <figure className="u-shadow-v19 g-bg-white g-rounded-4 g-pa-20">
                                       <div className="d-flex justify-content-start">
                                           <img className="g-width-90 g-height-90 rounded-circle g-mr-15" src="/img/4.jpg" alt="Image Description"/>
                                               <div className="d-block">

                                                   <div className="g-mb-5">
                                                       <h4 className="h5 g-mb-1">Abraham Nwoke</h4>
                                                       <em className="d-block g-color-gray-dark-v4 g-font-style-normal g-font-size-13">Google
                                                           Inc.</em>
                                                   </div>

                                                   <ul className="list-inline mb-0">
                                                       <li className="list-inline-item g-mx-2">
                                                           <a className="u-icon-v1 u-icon-slide-up--hover g-color-gray-dark-v4 g-color-facebook--hover g-ml-minus-15"
                                                              href="#!">
                                                       ...
                                                       <li className="list-inline-item g-mx-2">
                                                           <a className="u-icon-v1 u-icon-slide-up--hover g-color-gray-dark-v4 g-color-twitter--hover"
                                                              href="#!">
                                                       ...
                                                       <li className="list-inline-item g-mx-2">
                                                           <a className="u-icon-v1 u-icon-slide-up--hover g-color-gray-dark-v4 g-color-instagram--hover"
                                                              href="#!">
                                       ...
                                       <hr className="g-brd-gray-light-v4 g-my-15"/>
                                           ...
                                           <div className="g-py-10">
                                               ...
                                               <ul className="list-unstyled g-color-gray-dark-v5 g-font-size-13 g-mb-0">
                                                   <li className="g-mb-10">
                                                       <i className="g-pos-rel g-mt-1 mr-2 icon-communication-062 u-line-icon-pro"></i>
                                                       <a href="#!">abraham@gmail.com</a>
                                                   </li>
                                                   <li>
                                                       <i className="g-pos-rel g-top-1 mr-2 icon-electronics-005 u-line-icon-pro"></i>
                                                       <em className="g-font-style-normal">+233244491485</em>
                                                   </li>
                                               </ul>
                                           ...
                                           <hr className="g-brd-gray-light-v4 g-my-15"/>
                                               <div className="text-right mb-0">
                                                   <a className="u-link-v5 g-brd-around g-brd-gray-light-v3 g-color-black g-color-primary--hover g-font-size-12 rounded g-px-10 g-py-5" href="#!">All produce</a>
                                               </div>
                                   </figure>
                ...
                <section className=" auto-init height-is-based-on-content use-loading auth-page" data-options="{direction: 'reverse', settings_mode_oneelement_max_offset: '150'}">
                    ...
                    <div className="container">
                        <div className="text-center u-heading-v2-2--bottom g-brd-primary g-mb-50 g-pos-rel">
                            <h2 className="text-uppercase g-line-height-1_1 g-font-weight-700 g-font-size-26 g-mb-15">AgriShared Agents</h2>
                            <p className="mb-0">Curabitur ullamcorper ultricies nisi. Nam eget dui. Etiam
                                rhoncus.</p>
                        </div>
                ...
                <section className=" auto-init height-is-based-on-content use-loading auth-page" data-options="{direction: 'reverse', settings_mode_oneelement_max_offset: '150'}">
                    <div className="divimage dzsparallaxer--target w-100 g-bg-repeat"
                         style={{height: '200%', backgroundImage: 'url(/img/pattern1.png)'}}
                    ></div>
