            ...
            <div className="dashboard-register">
                <div className="container">
                    ...
                    <div className="problem-question">
                        ...
                        <div className="media g-brd-around question">
                            <div className="d-flex">
                                <div className="text-center">
                                    <img
                                        className="d-block user-img  g-width-50 rounded-circle mCS_img_loaded g-height-50  "
                            ...
                            <div className="media-body">
                                <div
                                    className=" header d-sm-flex justify-content-sm-between align-items-sm-center g-mb-15 g-mb-10--sm">
                                    <div className="left">
                                    ...
                                    <ul className="list-inline my-0 reactions">
                                        <li className="list-inline-item g-mr-20">
                                            <a className="g-color-gray-dark-v5 g-text-underline--none--hover" href="#!">
                                                <li><img src="/img/icons/icons8_Banana_48px.png" alt=""/></li>
                                                Like 15
                                            </a>
                                        </li>
                                        <li className="list-inline-item g-mr-20">
                                            <a className="g-color-gray-dark-v5 g-text-underline--none--hover" href="#!">
                                                <li><img src="/img/icons/icons8_Comments_30px.png" alt=""/></li>
                                                Responds 14
                                            </a>
                                        </li>
                                        <li className="list-inline-item g-mr-20">
                                            <a className="g-color-gray-dark-v5 g-text-underline--none--hover" href="#!">
                                                <li><img src="/img/icons/icons8_Chili_Pepper_48px.png" alt=""/></li>
                                                Dislikes 0
                                            </a>
                                        </li>
                                        <li className="list-inline-item g-mr-20">
                                            <a className="g-color-gray-dark-v5 g-text-underline--none--hover" href="#!">
                                                <li><img src="/img/icons/icons8_Detective_24px.png" alt=""/></li>
                                                viewss 1
                                            </a>
                                        </li>
                                    </ul>
                        ...
                        <div className="row mt-5">
                            ...
                            <div className="col-lg-10">
                                <div className="media g-brd-around question reply">
                                    <div className="d-flex">
                                        <div className="text-center">
                                            <img
                                                className="d-block user-img  g-width-50 rounded-circle mCS_img_loaded g-height-50  "
                                    ...
                                    <div className="media-body">
                                        <div
                                            className=" header d-sm-flex justify-content-sm-between align-items-sm-center g-mb-15 g-mb-10--sm">
                                            <div className="left">
                                                <h5 className="user-name h4 g-mr-10 g-mb-5 g-mb-0--sm">Abraham
                                                    Nwoke</h5>
                                                <span className="loc">Accra, Ghana</span>
                                                <span className="date">23.05.2019</span>
                                            </div>
