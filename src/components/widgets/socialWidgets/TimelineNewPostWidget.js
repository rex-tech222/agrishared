...
function TimelineNewPostWidget(props) {
    ...
    return (
        <div>
            ...
            <div className="post-container timeline">
                <div className="card">
                    <div className="card-header">
                        <img src="/user.png" alt=""/>
                    </div>
                    <div className="card-body">
                                         <textarea onClick={onWritePost} className="form-control" id="message" rows="3" placeholder="What' have you been up to ……"></textarea>
...
export default TimelineNewPostWidget
